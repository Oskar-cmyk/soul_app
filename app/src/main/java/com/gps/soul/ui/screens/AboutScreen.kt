...
fun AboutScreen(textColor: Color) {
    ...
    val cacheFileName = "about_cache.json" // Our dynamic local file
    val assetFileName = "about_backup.json" // Our read-only safety backup
    ...
    val jsonUrl = "https://codeberg.org/Oskar-cmyk/mockgps_android/raw/branch/main_des/app/src/main/assets/about_backup.json"
